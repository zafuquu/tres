...
// Points at the swertres-full backend we built and load-tested separately
// (Next.js + Postgres, /api/draws + /api/draws/:date). Set this to your
// deployed app's URL, e.g. VITE_API_BASE_URL=https://your-app.vercel.app
...
export const storage = {
  ...
  async set(key, value) {
    ...
    for (const rec of changed) {
      ...
      if (!safeRec.slot1 || !safeRec.slot2 || !safeRec.slot3) continue; // backend requires all 3 slots
